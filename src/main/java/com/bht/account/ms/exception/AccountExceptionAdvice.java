...
import com.bht.account.ms.vo.Response;
...
public class AccountExceptionAdvice {
	...
	public @ResponseBody ResponseEntity<ServiceResponse>  handleDemoException(HttpServletRequest request, AccountException ex){
